/* mca-rtc.js — Riverstone Kids Athletics (AEHub) NATIVE video conferencing (own WebRTC, no third party)
   ------------------------------------------------------------------------
...
(function () {
  ...
  var API = (window.LILNINJA_API||'https://ae-connect-api.vercel.app')+'/api/connect';
  ...
  window.LilNinjaMeet = ESPOAPI; window.MCAMeet = ESPOAPI; window.ESPOMeet = ESPOAPI; window.LCPMeet = ESPOAPI;
})();
